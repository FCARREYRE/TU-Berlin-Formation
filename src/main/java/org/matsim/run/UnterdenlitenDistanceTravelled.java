...
//        String inputFile = "C:/Users/marco/IdeaProjects/matsim-berlin-5.5.x/output_original_run/berlin-v5.5-1pct.output_events.xml.gz";
    ...
    private static class BerlinEventHandler implements LinkEnterEventHandler {
        ...
        private static Path inputNetwork = Paths.get("C:/Users/marco/IdeaProjects/matsim-berlin-5.5.x/output_dm/berlin-v5.5-1pct.output_network.xml.gz");
//        Config config;
...
//        MatsimNetworkReader(network).readFile(inputNetwork.toString());
        ...
        public static void fileWriter(){
            ...
            for(Map.Entry<Id<Vehicle>, Double> element : travelledDistanceByPerson.entrySet()){
                try {
//                    BufferedWriter writer = new BufferedWriter(new FileWriter("output_original_run/travelDistanceByPerson.txt", true));
                    BufferedWriter writer = new BufferedWriter(new FileWriter("output_dm1/travelDistanceByPerson.txt", true));
