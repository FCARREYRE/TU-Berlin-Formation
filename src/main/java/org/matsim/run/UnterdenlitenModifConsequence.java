...
//            System.out.println(personID);
        ...
        public static void fileWriter(){
            ...
            for(Map.Entry<Id<Person>, Double> element : travelTimeByPersonMap.entrySet()){
                try {
//                    BufferedWriter writer = new BufferedWriter(new FileWriter("output_original_run/travelTimeByPerson.txt", true));
                    BufferedWriter writer = new BufferedWriter(new FileWriter("output_dm1/travelTimeByPerson.txt", true));
